...
var CarouselComponent = /** @class */ (function () {
    function CarouselComponent(componentElement) {
        ...
        this.onInitCarousel = new core_1.EventEmitter();
        this.onReadyCarousel = new core_1.EventEmitter();
        this.onChangePropertiesCarousel = new core_1.EventEmitter();
        this.onSlideChange = new core_1.EventEmitter();
        this.onSlideCentered = new core_1.EventEmitter();
        this.onTransitionStart = new core_1.EventEmitter();
        this.onTransitionEnd = new core_1.EventEmitter();
        this.onSlideNextTransitionStart = new core_1.EventEmitter();
        this.onSlideNextTransitionEnd = new core_1.EventEmitter();
        this.onSlidePrevTransitionStart = new core_1.EventEmitter();
        this.onSlidePrevTransitionEnd = new core_1.EventEmitter();
        this.onSlideMove = new core_1.EventEmitter();
        this.onSlideMoveEnd = new core_1.EventEmitter();
        this.onSlideMoveStart = new core_1.EventEmitter();
        this.onTouchMove = new core_1.EventEmitter();
        this.onTouchStart = new core_1.EventEmitter();
        this.onTouchEnd = new core_1.EventEmitter();
        this.onReachBeginning = new core_1.EventEmitter();
        this.onReachEnd = new core_1.EventEmitter();
    ...
    CarouselComponent.propDecorators = {
        'morePairSlides': [{ type: core_1.Input, args: ["morePairSlides",] },],
        'angle': [{ type: core_1.Input, args: ["angle",] },],
        'ratioScale': [{ type: core_1.Input, args: ["ratioScale",] },],
        'margin': [{ type: core_1.Input, args: ["margin",] },],
        'perspective': [{ type: core_1.Input, args: ["perspective",] },],
        'endInSlide': [{ type: core_1.Input, args: ["endInSlide",] },],
        'timeToSlide': [{ type: core_1.Input, args: ["timeToSlide",] },],
        'lockSlides': [{ type: core_1.Input, args: ["lockSlides",] },],
        'initialSlide': [{ type: core_1.Input, args: ["initialSlide",] },],
        'loop': [{ type: core_1.Input, args: ["loop",] },],
        'axis': [{ type: core_1.Input, args: ["mode",] },],
        'autoPlay': [{ type: core_1.Input, args: ["autoPlay",] },],
        'delayAutoPlay': [{ type: core_1.Input, args: ["delayAutoPlay",] },],
        'onInitCarousel': [{ type: core_1.Output, args: ["onInit",] },],
        'onReadyCarousel': [{ type: core_1.Output, args: ["onReady",] },],
        'onChangePropertiesCarousel': [{ type: core_1.Output, args: ["onChangeProperties",] },],
        'onSlideChange': [{ type: core_1.Output, args: ["onSlideChange",] },],
        'onSlideCentered': [{ type: core_1.Output, args: ["onSlideCentered",] },],
        'onTransitionStart': [{ type: core_1.Output, args: ["onTransitionStart",] },],
        'onTransitionEnd': [{ type: core_1.Output, args: ["onTransitionEnd",] },],
        'onSlideNextTransitionStart': [{ type: core_1.Output, args: ["onSlideNextTransitionStart",] },],
        'onSlideNextTransitionEnd': [{ type: core_1.Output, args: ["onSlideNextTransitionEnd",] },],
        'onSlidePrevTransitionStart': [{ type: core_1.Output, args: ["onSlidePrevTransitionStart",] },],
        'onSlidePrevTransitionEnd': [{ type: core_1.Output, args: ["onSlidePrevTransitionEnd",] },],
        'onSlideMove': [{ type: core_1.Output, args: ["onSlideMove",] },],
        'onSlideMoveEnd': [{ type: core_1.Output, args: ["onSlideMoveEnd",] },],
        'onSlideMoveStart': [{ type: core_1.Output, args: ["onSlideMoveStart",] },],
        'onTouchMove': [{ type: core_1.Output, args: ["onTouchMove",] },],
        'onTouchStart': [{ type: core_1.Output, args: ["onTouchStart",] },],
        'onTouchEnd': [{ type: core_1.Output, args: ["onTouchEnd",] },],
        'onReachBeginning': [{ type: core_1.Output, args: ["onReachBeginning",] },],
        'onReachEnd': [{ type: core_1.Output, args: ["onReachEnd",] },],
        'carouselElm': [{ type: core_1.ViewChild, args: ["carousel",] },],
